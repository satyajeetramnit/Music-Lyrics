...
function showSongs(data) {
  ...
  data.data.forEach((song) => {
    ...
    <div style="margin-top:25px;">
      <li><span><img style="border-radius:50%;" class="song_image" alt="image.jpg" src="${song.artist.picture_small}"/></span><div style="width:300px; text-align:left;"><span><strong>${song.artist.name}</strong> - ${song.title}</span></div>
      <audio controls width="220" height="30"><source src="${song.preview}"></audio>
